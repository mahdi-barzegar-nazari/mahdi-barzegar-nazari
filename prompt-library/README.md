# 📝 Prompt Library (Persian) | کتابخانهٔ پرامپت فارسی

این یک مجموعهٔ در حال رشد از پرامپت‌های مفید و آمادهٔ استفاده برای دانشجویان ایرانی است که می‌خواهند از ابزارهای هوش مصنوعی (مانند Claude و ChatGPT) برای یادگیری بهتر استفاده کنند.
